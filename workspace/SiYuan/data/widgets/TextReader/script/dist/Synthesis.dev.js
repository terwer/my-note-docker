...
function play() {
  ...
  to_speak = new SpeechSynthesisUtterance(_play.value); //to_speak.rate = 1.4;// 设置播放语速，范围：0.1 - 10之间
  ...
  window.speechSynthesis.speak(to_speak); //console.log(to_speak);
...
oContent.onmouseup = function () {
  if (selectText()) {
    var msg = new SpeechSynthesisUtterance(selectText());
